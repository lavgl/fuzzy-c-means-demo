...
var G__34641 = cljs.core.first.call(null,element_str);
switch (G__34641) {
case "?":
arr.push((1));
...
var G__34643 = cljs.core.next.call(null,items);
items = G__34643;
continue;
} else {
return null;
...
var G__34644 = cljs.core.next.call(null,items);
items = G__34644;
continue;
} else {
return null;
...
var G__34646 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__34646;
continue;
} else {
return true;
...
switch (G__34649) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__34649){
return (function (p1__34647_SHARP_){
return cljs.core.not_EQ_.call(null,p1__34647_SHARP_,(2));
});})(G__34649))
))){
...
return cljs.core.not_EQ_.call(null,p1__34648_SHARP_,(1));
});})(G__34649))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34649)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1510655881182
