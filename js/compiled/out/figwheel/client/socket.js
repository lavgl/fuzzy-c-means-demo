...
}catch (e45998){if((e45998 instanceof Error)){
var e = e45998;
return null;
} else {
throw e45998;
...
var and__30036__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__30036__auto__){
var and__30036__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__30036__auto____$1)){
var and__30036__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__45999){
...
var opts = map__46000__$1;
var retry_count = cljs.core.get.call(null,map__46000__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__46000__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__46000__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__46000__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__5276__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
if(cljs.core.truth_(temp__5276__auto__)){
var WebSocket = temp__5276__auto__;
...
socket.onclose = ((function (url,socket,WebSocket,temp__5276__auto__,map__46000,map__46000__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__30048__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__5276__auto__,map__46000,map__46000__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__5276__auto__,map__46000,map__46000__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__30407__auto__ = (10000);
var y__30408__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__5276__auto__,map__46000,map__46000__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1510655894609
