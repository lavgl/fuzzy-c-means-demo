...
var or__30048__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj44941 = {"detail":data};
return obj44941;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30036__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30036__auto__)){
var and__30036__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__44948 = cljs.core._EQ_;
var expr__44949 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44948.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44949))){
return ((function (pred__44948,expr__44949){
return (function (p1__44942_SHARP_){
return console.warn(p1__44942_SHARP_);
});
;})(pred__44948,expr__44949))
} else {
if(cljs.core.truth_(pred__44948.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44949))){
return ((function (pred__44948,expr__44949){
return (function (p1__44943_SHARP_){
return console.debug(p1__44943_SHARP_);
});
;})(pred__44948,expr__44949))
} else {
if(cljs.core.truth_(pred__44948.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44949))){
return ((function (pred__44948,expr__44949){
return (function (p1__44944_SHARP_){
return console.error(p1__44944_SHARP_);
});
;})(pred__44948,expr__44949))
} else {
return ((function (pred__44948,expr__44949){
return (function (p1__44945_SHARP_){
return console.log(p1__44945_SHARP_);
});
;})(pred__44948,expr__44949))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44952){
...
var eval_fn = cljs.core.get.call(null,map__44953__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44955_SHARP_);
});})(new_def))
);
...
return (function (p__44956){
var vec__44957 = p__44956;
var ky = cljs.core.nth.call(null,vec__44957,(0),null);
var v = cljs.core.nth.call(null,vec__44957,(1),null);
...
if(cljs.core.truth_((function (){var and__30036__auto__ = typeof localStorage !== 'undefined';
...
}catch (e44962){if((e44962 instanceof Error)){
var e = e44962;
return not_found;
} else {
throw e44962;
...
//# sourceMappingURL=utils.js.map?rel=1510655893860
