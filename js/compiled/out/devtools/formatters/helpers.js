...
var G__48475 = devtools.prefs.pref.call(null,v);
v = G__48475;
continue;
} else {
return v;
...
var and__30036__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__30036__auto__){
var and__30036__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__30048__auto__ = (function (){try{if(!((value == null))){
...
}catch (e48478){var _e__47742__auto__ = e48478;
return false;
}})();
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
var or__30048__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e48482){var _e__47742__auto__ = e48482;
return false;
}})();
...
}catch (e48484){var _e__47742__auto__ = e48484;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__30036__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30036__auto__)){
var and__30036__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__30036__auto____$1){
...
var and__30036__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__30036__auto__)){
...
var or__30048__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
...
var and__30036__auto__ = (function (){var or__30048__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
...
var vec__48486 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__48486,(0),null);
var name = cljs.core.nth.call(null,vec__48486,(1),null);
...
var and__30036__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__30036__auto__)){
...
var or__30048__auto__ = typeof value === 'string';
if(or__30048__auto__){
return or__30048__auto__;
} else {
var or__30048__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__48489_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__48489_SHARP_);
}),template);
});
...
var temp__5276__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__5276__auto__)){
var render_pref = temp__5276__auto__;
if(render_pref === true){
...
//# sourceMappingURL=helpers.js.map?rel=1510655898304
