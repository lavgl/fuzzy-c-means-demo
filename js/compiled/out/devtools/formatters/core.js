...
var and__30036__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__30036__auto__){
var or__30048__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e49052){var _e__47742__auto__ = e49052;
return false;
...
}catch (e49054){var _e__47742__auto__ = e49054;
return false;
...
}catch (e49056){var _e__47742__auto__ = e49056;
return false;
...
}catch (e49058){var _e__47742__auto__ = e49058;
return false;
...
}catch (e49060){var _e__47742__auto__ = e49060;
return false;
}})())){
...
}catch (e49062){var _e__47742__auto__ = e49062;
return false;
}})())){
...
var _STAR_current_state_STAR_49064 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__30048__auto__ = config;
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_49064;
}});
});
...
return (function() { 
var G__49066__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e49065){var e = e49065;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__49066 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__49067__i = 0, G__49067__a = new Array(arguments.length -  0);
while (G__49067__i < G__49067__a.length) {G__49067__a[G__49067__i] = arguments[G__49067__i + 0]; ++G__49067__i;}
  args = new cljs.core.IndexedSeq(G__49067__a,0,null);
} 
return G__49066__delegate.call(this,args);};
G__49066.cljs$lang$maxFixedArity = 0;
G__49066.cljs$lang$applyTo = (function (arglist__49068){
var args = cljs.core.seq(arglist__49068);
return G__49066__delegate(args);
});
G__49066.cljs$core$IFn$_invoke$arity$variadic = G__49066__delegate;
return G__49066;
})()
;
});
...
var pre_handler = (function (){var or__30048__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
...
var post_handler = (function (){var or__30048__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1510655899316
