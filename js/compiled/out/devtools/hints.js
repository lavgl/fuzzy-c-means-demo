...
var temp__5276__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
if(cljs.core.truth_(temp__5276__auto__)){
var val = temp__5276__auto__;
return val;
} else {
...
var reader = (function (){var or__30048__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30048__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30048__auto__)){
return or__30048__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__49259__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__49259__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__49259__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e49258){var _e = e49258;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5276__auto___49261 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5276__auto___49261)){
var seen_errors_49262 = temp__5276__auto___49261;
if(cljs.core.truth_(seen_errors_49262.has(self))){
} else {
seen_errors_49262.add(self);

var temp__5278__auto___49263 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5278__auto___49263)){
var sense_49264 = temp__5278__auto___49263;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_49264)].join('');
} else {
}
}
} else {
...
var temp__5278__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__5278__auto__)){
var sense = temp__5278__auto__;
...
//# sourceMappingURL=hints.js.map?rel=1510655899649
